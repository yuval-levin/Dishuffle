...
def return_random_dish(lat, long, set_of_unwanted_dishes, username):
    ...
    with requests.session() as session:
        ...
        restaurant_name = restaurant['name'][1]['value'] if len(restaurant['name']) > 1 else  restaurant['name'][0]['value']

        dish = choose_random_dish(restaurant_name, menu, set_of_unwanted_dishes, session, username, category_address,food_category)
...
def choose_random_dish(restaurant_name, menu, set_of_unwanted_dishes, session, username, category_address,food_category):
